...
BOXING_CALENDAR_ID = config('VITE_BOXING_CALENDAR_ID')
STUDIO_CALENDAR_ID = config('VITE_STUDIO_CALENDAR_ID')
FITNESS_CALENDAR_ID = config('VITE_FITNESS_CALENDAR_ID')
OWEIGHTLIFTING_CALENDAR_ID = config('VITE_OWEIGHTLIFTING_CALENDAR_ID')
VONS_PRIVATES_ID = config('VITE_VONS_PRIVATES_ID')
